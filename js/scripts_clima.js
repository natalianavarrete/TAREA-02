...
$.getJSON("geojason/Estructuras.geojson", function(geodata) {
	var layer_geojson_Estructuras = L.geoJson(geodata, {
		style: function(feature) {return {'color': "#943126"}}}).addTo(map);
	control_layers.addOverlay(layer_geojson_Estructuras, 'Estructuras');
});
